const products = [
  ...
  { id: 12, name: "Corgi", category: "Perritos", price: 20, image: "corgie.png", featured: 12, description: "Perrito Corgi articulado impreso en 3D." },
  { id: 13, name: "Chihuahua", category: "Perritos", price: 20, image: "chihuahua.png", featured: 13, description: "Perrito Chihuahua articulado impreso en 3D." },
  { id: 14, name: "Pastor Alemán", category: "Perritos", price: 20, image: "pastor aleman.png", featured: 14, description: "Perrito Pastor Alemán articulado impreso en 3D." },
  { id: 15, name: "Bull Terrier", category: "Perritos", price: 20, image: "bullterrier.jpg", featured: 15, description: "Perrito Bull Terrier articulado impreso en 3D." },
  { id: 16, name: "Yorkshire", category: "Perritos", price: 20, image: "yorki.jpg", featured: 16, description: "Perrito Yorkshire articulado impreso en 3D." },
  { id: 17, name: "Beagle", category: "Perritos", price: 20, image: "beaglle.jpg", featured: 17, description: "Perrito Beagle articulado impreso en 3D." },
  { id: 18, name: "Boxer", category: "Perritos", price: 20, image: "boxer.jpg", featured: 18, description: "Perrito Boxer articulado impreso en 3D." },
  { id: 19, name: "Pomerania", category: "Perritos", price: 20, image: "pome.jpg", featured: 19, description: "Perrito Pomerania articulado impreso en 3D." },
  { id: 20, name: "Golden Retriever / Labrador", category: "Perritos", price: 20, image: "golden and labrador.png", featured: 20, description: "Perrito Golden Retriever o Labrador articulado impreso en 3D." },
  { id: 21, name: "Husky", category: "Perritos", price: 20, image: "husky.png", featured: 21, description: "Perrito Husky articulado impreso en 3D." },
  { id: 22, name: "Cocker Spaniel", category: "Perritos", price: 20, image: "coqquer.png", featured: 22, description: "Perrito Cocker Spaniel articulado impreso en 3D." },
  { id: 23, name: "Dálmata", category: "Perritos", price: 20, image: "dalmata.png", featured: 23, description: "Perrito Dálmata articulado impreso en 3D." },
  { id: 24, name: "American Bully", category: "Perritos", price: 20, image: "bully.png", featured: 24, description: "Perrito American Bully articulado impreso en 3D." },
  { id: 25, name: "Pastor Belga", category: "Perritos", price: 20, image: "pastor belga.png", featured: 25, description: "Perrito Pastor Belga articulado impreso en 3D." },
  { id: 26, name: "Rottweiler", category: "Perritos", price: 20, image: "rotwailer.jpg", featured: 26, description: "Perrito Rottweiler articulado impreso en 3D." },
